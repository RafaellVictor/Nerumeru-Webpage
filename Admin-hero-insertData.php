              ...
              <form class="w-full" action="" method="post">
                <div class="grid grid-cols-2 gap-6">
                  ...
                  <div class="w-full flex flex-col gap-4  bg-white-neru rounded-md border-2 p-3">
                      ...
                      <label for="">Hero Img <span class="text-red-500 font-medium">(Note : 2 Type File input file & link img)</span> </label>
                      <input type="file">
                      <input class="w-full p-2 outline-none border-2" type="text" name="hero_img" />
                    </div>
                    <label for="">Title 1</label>
                    <input required class="w-full p-2 outline-none border-2" name="hero_title1" placeholder="Nerumeru's Delightful Pets" type="text" />
                    <label for="">Title 2</label>
                    <input required class="w-full p-2 outline-none border-2" name="hero_title2" placeholder="Nerumeru's Delightful Pets" type="text" />
                    <label for="">Title 3</label>
                    <input required class="w-full p-2 outline-none border-2" name="hero_title3" placeholder="Nerumeru's Delightful Pets" type="text" />
                  </div>
                  <div class="flex flex-col w-full gap-3">
                    <label for="">Subtitle</label>
                    <textarea required class="p-2 outline-none border-2 text-start" name="hero_subtitle" placeholder="Your Subtitle" cols="30" rows="10"></textarea>
                    <label for="">Button 1</label>
                    <input required class="w-full p-2 outline-none border-2" name="hero_button1" placeholder="Explore Now" type="text" />
                    <label for="">Button 2</label>
                    <input required class="w-full p-2 outline-none border-2" name="hero_button2" placeholder="Shop Collections" type="text" />
                    <label for="">Status Content</label>
                    <input required class="w-full p-2 outline-none border-2" name="hero_status" value="0" readonly type="text" />
