                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div class="flex flex-col w-full gap-3">
                                        <div class="w-full flex flex-col gap-4  bg-white-neru rounded-md border-2 p-3">
                                            ...
                                            <input class="w-full p-2 outline-none border-2" type="text" name="recommend_img" />
                                        </div>
                                        <label for="">Title 1</label>
                                        <input required class="w-full p-2 outline-none border-2" name="recommend_title" placeholder="Nerumeru's Delightful Pets" type="text" />
                                    </div>
                                    <div class="flex flex-col w-full gap-3">
