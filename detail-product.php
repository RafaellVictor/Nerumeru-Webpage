...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <section class="product-details lg:mt-44 md:mt-32">
        <div class="container">
          ...
          <div class="item mt-5 grid md:grid-cols-7 gap-10 grid-cols-1">
              ...
              <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="img/card-item-2.png" class="w-full 3xl:h-[700px] 2xl:h-[550px] xl:h-[520px] md:h-[300px] h-[320px] object-fill" alt="" />
                  </div>
                  <div class="swiper-slide">
                    <img src="img/card-item.png" class="w-full 3xl:h-[700px] 2xl:h-[550px] xl:h-[520px] md:h-[300px] h-[320px] object-fill" alt="" />
                  </div>
                  <div class="swiper-slide">
                    <img src="img/card-item3.png" class="w-full 3xl:h-[700px] 2xl:h-[550px] xl:h-[520px] md:h-[300px] h-[320px] object-fill" alt="" />
                  </div>
                  <div class="swiper-slide">
                    <img src="img/card-item5.png" class="w-full 3xl:h-[700px] 2xl:h-[550px] xl:h-[520px] md:h-[300px] h-[320px] object-fill" alt="" />
                  </div>
                  <div class="swiper-slide">
                    <img src="img/card-item4.png" class="w-full 3xl:h-[700px] 2xl:h-[550px] xl:h-[520px] md:h-[300px] h-[320px] object-fill" alt="" />
                  </div>
                </div>
              </div>
            ...
            <div class="right-content col-span-4">
              <div class="wrapper flex flex-col gap-4">
                <h2 class="font-bold">Neru One - Silver Grey</h2>
                ...
                <h6>Rp.500,000</h6>
                <h6 class="flex gap-2.5 items-center font-semibold lg:text-base md:text-sm text-[11px]">Stock <span class="stock bg-blue-Neru md:px-3 px-2.5 py-0.5 rounded-md text-white lg:text-base md:text-sm text-[11px]">26</span></h6>
                <h6 class="flex gap-3">Weight <span>500g</span></h6>
                <hr />
                <h6 class="flex justify-between">Sub Total <span class="font-semibold">Rp 500.000</span></h6>
                <hr />
                <div class="quantity flex md:gap-3 gap-1.5">
                  <span id="qty" class="flex gap-2">
                    <button class="bg-blue-Neru w-10 text-white h-10 flex items-center justify-center rounded-sm lg:text-base text-sm">-</button>
                    <input type="number" class="current-page w-10 h-10 text-center py-1 bg-white shadow-lg md:text-2xl text-sm outline-none border-blue-Neru border-[1px]"  min="0" max="9" value="1" />
                    <button class="bg-blue-Neru w-10 text-white h-10 flex items-center justify-center rounded-sm lg:text-base text-sm">+</button>
                  </span>
              ...
              <div class="flex flex-col gap-0.5">
                  ...
                  <div class="accordion-body bg-white shadow-sm">
                    <div class="content-wrapper p-4">
                      <span class="md:text-base text-sm">
                        Product Size: Medium (100 cm x 75 cm x 10 cm) <br /><br />
                        Foam Specification: <br />
                        - 5 CM Soft Memory Foam (White) <br />
                        - 5 CM Medium Support Foam (Yellow) <br />
                        Inner Fabric Polyester Cotton (Dark Grey), Water Resistant, Breathable with Machine Washable Cover. <br /><br />
                        Outer Fabric Premium Fabric made of Polyester, Super Tough, Comfortable, Soft with Machine Washable Cover and Anti Slip Fabric. Zipper YKK (Middle-Inner) and YKK (Under-Outer)
                      </span>
                    </div>
                  </div>
                </div>
                <div class="accordion-wrapper">
                  ...
                  <div class="accordion-body bg-white shadow-sm">
                    <div class="content-wrapper p-4">
                      <span class="md:text-base text-sm"> 1 Year (Foam, 20% Deflated) - 1 year warranty for inner foam if there is a 20% decrease </span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          ...
          <div class="swiper my-10">
            <div class="otherProduct-Content">
              <div class="swiper-wrapper">
                <div class="h-fit card-wrapper swiper-slide shadow-lg flex flex-col w-full gap-3 bg-white rounded-md transition-all ease-in-out duration-300">
