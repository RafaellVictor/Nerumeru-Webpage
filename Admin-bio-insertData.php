                            ...
                            <form class="w-full" action="" method="post">
                                <div class="grid grid-cols-2 gap-6">
                                    <div class="flex flex-col w-full gap-3">
                                        ...
                                        <input required class="w-full p-2 outline-none border-2" name="bio_title" placeholder="Nerumeru's Delightful Pets" type="text" />
                                        <label for="">Subtitle bio</label>
                                        <input required class="w-full p-2 outline-none border-2" name="bio_subtitle" placeholder="Nerumeru's Delightful Pets" type="text" />
                                    </div>
                                    <div class="flex flex-col w-full gap-3">
                                        <label for="">Full Bio</label>
                                        <textarea name="bio_full" class="w-full p-2 outline-none border-2" id="" cols="30" rows="10"></textarea>
