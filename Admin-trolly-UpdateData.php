              ...
              <form class="w-full" action="" method="post" enctype="multipart/form-data">
                <div class="grid grid-cols-2 gap-6">
                  <div class="flex flex-col w-full gap-3">
                    ...
                    <input class="w-full p-2 outline-none border-2" value="<?= $nerumeru["trolly_size"] ?>" name="trolly_size" placeholder="Trolly Size" type="text" />
                    <label for="">Trolly Color</label>
                    <input class="w-full p-2 outline-none border-2" value="<?= $nerumeru["trolly_color"] ?>" name="trolly_color" placeholder="Trolly Color" type="text" />
