          ...
          <div class="form-wrapper">
            <div class="overflow-hidden relative mx-auto flex flex-col gap-3 items-center text-white justify-center px-16 rounded-lg w-[539px] h-[582px] backdrop-blur-2xl">
              <div id="BoxLogin" class="w-full flex flex-col gap-9 items-center text-white">
                ...
                <form action="" class="w-full font-semibold mt-6 flex flex-col">
                  <span class="flex flex-col gap-8">
                    <div class="flex w-full relative">
                      <input type="text" placeholder="Email / No Tlpn" class="inputLogin xl:text-base md:text-base text-sm w-full py-3 outline-none bg-transparent border-b-2 border-white" />
                    ...
                    <div class="flex w-full relative">
                      <input type="text" placeholder="Password" class="inputLogin xl:text-base md:text-base text-sm w-full py-3 outline-none bg-transparent border-b-2 border-white" />
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon absolute right-0 bottom-1/2 translate-y-1/2 icon-tabler icon-tabler-eye-off" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                  ...
                  <span class="flex justify-between mt-6">
                    ...
                    <a href="#" class="text-white"><h6>Forget Password ?</h6></a>
                  </span>
                  <button class="w-full bg-blue-Neru p-3 text-white rounded-lg mt-6"><h6>Login</h6></button>
              ...
              <div id="BoxRegister" class="absolute z-10 transition-all ease-in-out duration-500 invisible -translate-y-full bg-blue-Neru h-full bottom-0 rounded-t-lg justify-center px-16 inset-x-0 w-full flex flex-col gap-9 items-center text-white">
                ...
                <form action="" class="w-full font-semibold mt-6 flex flex-col">
                  <span class="flex flex-col gap-8">
                    <div class="flex w-full relative">
                      <input type="text" placeholder="Email" class="inputLogin xl:text-base md:text-base text-sm w-full py-3 outline-none bg-transparent border-b-2 border-white" />
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon absolute right-0 bottom-1/2 translate-y-1/2 icon-tabler icon-tabler-mail" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z" />
                        <path d="M3 7l9 6l9 -6" />
                    ...
                    <div class="flex w-full relative">
                      <input type="text" placeholder="No Tlpn" class="inputLogin xl:text-base md:text-base text-sm w-full py-3 outline-none bg-transparent border-b-2 border-white" />
                  ...
                  <button class="w-full bg-white p-3 text-black rounded-lg mt-6"><h6>Register</h6></button>
                  <h6 class="text-center mt-6">
