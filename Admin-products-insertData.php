              ...
              <form class="w-full" action="" method="post">
                <div class="grid grid-cols-2 gap-6">
                  ...
                  <div class="flex flex-col w-full gap-3">
                    ...
                    <textarea required class="p-2 outline-none border-2 text-start" name="product_specification" placeholder="Product Specification" cols="30" rows="10"></textarea>
                    <label for="">Weight</label>
                    <input required class="w-full p-2 outline-none border-2" name="product_weight" placeholder="Product Weight" type="text" />
                    <label for="">Warranty</label>
                    <input required class="w-full p-2 outline-none border-2" name="product_warranty" placeholder="Product Warrranty" type="text" />
