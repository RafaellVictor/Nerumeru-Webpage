                            ...
                            <form class="w-full" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    <div class="parent-input w-full flex flex-col gap-4 bg-white-neru rounded-md border-2 p-3">
                                        <img src="img/" onerror="this.src='https://salonlfc.com/wp-content/uploads/2018/01/image-not-found-1-scaled-1150x647.png'" class="mx-auto previewImg" alt="">
                                ...
                                <button type="submit" name="submit" class="bg-green-400 p-2 rounded-md text-white font-semibold w-[13%] mt-6">Tambah Data</button>
                            </form>
                        </div>
                    </div>
                </div>
