        ...
        <span class="flex md:flex-col flex-col-reverse">
          <div class="container relative 3xl:top-32 xl:top-20 md:top-2.5">
            <div class="flex flex-col items-center lg:gap-6 gap-4">
              <h2 id="text" class="w-fit mx-auto 3xl:h-28 2xl:h-[85px] md:h-[72px] h-10 text-center font-extrabold leading-tight text-blue-Neru"></h2>
              ...
              <a href="catalog.html" class="cursor-pointer outline hover:outline-none hover:text-white outline-2 relative w-fit mx-auto group outline-grey-neru text-grey-neru transition-all ease-linear duration-200 lg:px-4 px-2.5 lg:text-sm text-xs py-1.5 font-bold rounded-full overflow-hidden"
                ><?= $hero_section["hero_button2"] ?>
          ...
          <div class="container 3xl:mt-48 2xl:mt-24 xl:mt-20 md:mt-0 mt-5">
            <img src="<?= $hero_section["hero_img"] ?>" class="mx-auto xl:w-[55%] md:w-[60%] w-fit h-[45%]" alt="" />
          </div>
        </span>
      </section>
        ...
        <div class="container">
          ...
          <div class="grid md:grid-cols-4 grid-cols-2 mt-12 mx-auto 3xl:gap-16 2xl:gap-10 xl:gap-5 gap-3">
            <div class="text-center relative group overflow-hidden cursor-pointer">
              <img src="img/Orthopendic.png" class="w-full object-fill" alt="" />
              <div class="absolute -translate-y-full group-hover:translate-y-0 transition-all ease-in-out duration-200 n h-full inset-0 bg-blue-Neru bg-opacity-70 text-white p-4 flex items-center flex-col lg:gap-4 md:gap-2 gap-1 justify-center">
                <h6 class="font-bold lg:text-base md:text-xs text-[8px]">Water Resistance Inner Cover</h6>
                <h6 class="lg:text-sm md:text-xs text-[8px] font-medium lg:text-center text-justify line-clamp-4">The inner layer of NeruMeru Bed cover is made of water ressistant that helps protect your bed from spills and dirt. </h6>
              </div>
            </div>
            <div class="text-center relative group overflow-hidden cursor-pointer">
              <img src="img/Washing mechine.png" class="w-full object-fill" alt="" />
              <div class="absolute -translate-y-full group-hover:translate-y-0 transition-all ease-in-out duration-200 n h-full inset-0 bg-blue-Neru bg-opacity-80 text-white p-4 flex items-center flex-col lg:gap-4 md:gap-2 gap-1 justify-center">
                <h6 class="font-bold lg:text-base md:text-xs text-[8px]">Easy to Wash</h6>
                <h6 class="lg:text-sm md:text-xs text-[8px] font-medium lg:text-center text-justify line-clamp-4">Developed with easy to wash design and material. If get it dirty, you can easily wash it with washing machine.</h6>
              </div>
            </div>
            <div class="text-center relative group overflow-hidden cursor-pointer">
              <img src="img/Dog.png" class="w-full object-fill" alt="" />
              <div class="absolute -translate-y-full group-hover:translate-y-0 transition-all ease-in-out duration-200 n h-full inset-0 bg-blue-Neru bg-opacity-80 text-white p-4 flex items-center flex-col lg:gap-4 md:gap-2 gap-1 justify-center">
                <h6 class="font-bold lg:text-base md:text-xs text-[8px]">Orthopedic & Japan Technology</h6>
                <h6 class="lg:text-sm md:text-xs text-[8px] font-medium lg:text-center text-justify line-clamp-4">Developed with Japan Technology & Orthopedic best quality material for long-lasting durability to provide your pet with a better sleep.</h6>
              </div>
            </div>
            <div class="text-center relative group overflow-hidden cursor-pointer">
              <img src="img/Save-bio.png" class="w-full object-fill" alt="" />
              <div class="absolute -translate-y-full group-hover:translate-y-0 transition-all ease-in-out duration-200 h-full inset-0 bg-blue-Neru bg-opacity-80 text-white p-4 flex items-center flex-col lg:gap-4 md:gap-2 gap-1 justify-center">
                <h6 class="font-bold lg:text-base md:text-xs text-[8px]">ROHS Certifications</h6>
                <h6 class="lg:text-sm md:text-xs text-[8px] font-medium lg:text-center text-justify line-clamp-4">ROHS Certification limits hazardous substances (e.g., lead, mercury, hexavalent chromium, cadmium) to acceptable levels.</h6>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="text-white text-center mt-12">
            <div class="grid md:grid-cols-6 md:grid-rows-6 grid-cols-4 grid-rows-4 md:gap-4 gap-2 h-[600px] max-w-screen mx-auto lg:text-4xl md:text-xl text-sm">
              <div onclick="window.location.href ='bedding.html';" class="md:col-span-4 md:row-span-4 col-span-4 row-span-1 bg-blue-Neru bg-bed-catalog bg-no-repeat bg-cover bg-center relative overflow-hidden group cursor-pointer">
                <div class="overlay-text bg-black bg-opacity-70 absolute inset-0 flex items-center -translate-x-full group-hover:-translate-x-0 transition-all ease-in-out duration-500 justify-center font-extrabold tracking-widest">NERU BEDDING</div>
              </div>
              <div onclick="window.location.href ='sanitize.html';" class="bg-blue-Neru md:row-span-3 md:col-span-2 col-span-2 row-span-1 bg-sanitize-catalog bg-no-repeat bg-cover bg-center relative overflow-hidden group cursor-pointer">
                <div class="overlay-text bg-black bg-opacity-70 absolute inset-0 flex items-center translate-x-full group-hover:translate-x-0 transition-all ease-in-out duration-500 justify-center font-extrabold tracking-widest">NERU SANITIZE</div>
              </div>
              <div onclick="window.location.href ='trolly.html';" class="bg-blue-Neru md:col-span-2 md:row-span-5 col-span-2 row-span-2 bg-trolly-catalog bg-no-repeat bg-cover bg-center relative overflow-hidden group cursor-pointer">
                <div class="overlay-text bg-black bg-opacity-70 absolute inset-0 flex items-center -translate-y-full group-hover:-translate-y-0 transition-all ease-in-out duration-500 justify-center font-extrabold tracking-widest">NERU TROLLY</div>
              </div>
              <div onclick="window.location.href ='toys.html';" class="bg-blue-Neru w-full md:col-span-2 md:row-span-4 col-span-2 bg-toys-catalog bg-no-repeat bg-cover bg-center relative overflow-hidden group cursor-pointer">
                <div class="overlay-text bg-black bg-opacity-70 absolute inset-0 flex items-center translate-y-full group-hover:translate-y-0 transition-all ease-in-out duration-500 justify-center font-extrabold tracking-widest">NERU TOYS</div>
              </div>
              <div onclick="window.location.href ='pillow.html';" class="bg-blue-Neru md:col-span-2 md:row-span-4 col-span-4 bg-pillow-catalog bg-no-repeat bg-cover bg-center relative overflow-hidden group cursor-pointer">
                <div class="overlay-text bg-black bg-opacity-70 absolute inset-0 flex items-center translate-x-full group-hover:translate-x-0 transition-all ease-in-out duration-500 justify-center font-extrabold tracking-widest">NERU PILLOW</div>
              </div>
            </div>
          </div>
        </div>
